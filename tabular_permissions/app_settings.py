...
TABULAR_PERMISSIONS_CONFIG = {
    ...
    'exclude': {
        'override': False,
        'apps': ['authtoken', 'background_task', 'creditcard_management'],
        'models': ['application_message',
                   'applicationactivitylog',
                   'applicationfollowupdetails',
                   'applicationupdatelog',
                   'creditcardname',
                   'customerbusinessinfo',
                   'customercardsinfo',
                   'customerjobinfo',
                   'customerlandlordinfo',
                   'customersloaninfo',
                   'eligibilitybusiness',
                   'eligibilitycarddetails',
                   'eligibilitylandlord',
                   'eligibilitysalaried',
                   'feescharges',
                   'fixeddeposittrade',
                   'groupprofile',
                   'loan',
                   'loanbusinesseligibility',
                   'loandetails',
                   'loaneligibility',
                   'loanrentaleligibility',
                   'loansalariedaccountminsalary',
                   'loansalariedeligibilitydetails',
