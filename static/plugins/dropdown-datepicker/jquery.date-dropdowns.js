;(function ($, window, document, undefined) {
    ...
    var pluginName = 'dateDropdowns',
        pluginDefaults = {
            ...
            minAge: 0,
            maxAge: 120,
            allow_next_date: true,
            minYear: null,
            maxYear: null,
            submitFieldName: 'date',
            wrapperClass: 'date-dropdowns input-group',
            dropdownClass: null,
            daySuffixes: true,
            monthSuffixes: true,
            monthFormat: 'long',
    ...
    $.extend(Plugin.prototype, {
        ...
        setupMarkup: function () {
            ...
            // console.log(this.element.tagName.toLowerCase(), this.element)
            if (this.element.tagName.toLowerCase() === 'input') {
                ...
                hiddenField = this.$element.attr('type', 'text').attr('style','display:none')
        ...
        buildMonthDropdown: function () {
            ...
            dropdown.append(option);
            let month_no = 12
            if (!this.config.allow_next_date) {
                let this_date = new Date()
                let this_month = this_date.getMonth() + 1
                month_no = this_month
            }
            // Populate the month values
            for (var monthNo = 1; monthNo <= month_no; monthNo++) {
        ...
        checkDate: function (day, month, year) {
            ...
            if (year == current_year) {
                this.update_month_year_options()
            }

            return invalidDate;
        },

        update_month_year_options: function () {
    ...
    $.fn[pluginName] = function (options) {
        // console.log(options)
        this.each(function () {
            // console.log($(this), typeof options)
            if (typeof options === 'string') {
                ...
                // console.log(this, 'this', $.data(this, 'plugin_' + pluginName), !$.data(this, 'plugin_' + pluginName))
