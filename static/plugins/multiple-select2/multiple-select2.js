(function (global, factory) {
  ...
  */
    ...
    _createClass(MultipleSelect2, [{
      ...
      value: function initLocale() {
        if (this.options.locale) {
          var locales = $.fn.multipleSelect2.locales;
  ...
  $.fn.multipleSelect2 = function (option) {
    ...
    this.each(function (i, el) {
      var $this = $(el);
      var data = $this.data('multipleSelect2');
      var options = $.extend({}, $this.data(), _typeof(option) === 'object' && option);

      if (!data) {
        data = new MultipleSelect2($this, options);
        $this.data('multipleSelect2', data);
      }
      ...
      if (typeof option === 'string') {
        ...
        if (option === 'destroy') {
          $this.removeData('multipleSelect2');
        }
      } else {
        data.init();
      }
  ...
  $.fn.multipleSelect2.defaults = Constants.DEFAULTS;
  $.fn.multipleSelect2.locales = Constants.LOCALES;
  $.fn.multipleSelect2.methods = Constants.METHODS;
